...
{-------------------------------------------------------------------------------
  ...
  Description
    ...
    UPDATE June 2026: This is testing fine.  Previous failure might have been
      because IM.Applications.MainForm.SaveGlobalSettings was modified to only run if --configure was
      called.   If you use IM.Applications.MainForm, you can bypass the
  ...
  History
    ...
    2024-01-22: Migrated to Github.  Added to refactored package "IM.units"
